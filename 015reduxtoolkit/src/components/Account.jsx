...
import {increment, decrement, incrementByAmount} from '../store/slice/account/accountSlice.js'
import {useState} from 'react'
import { fetchData } from '../store/slice/api/apiSlice.js';
const Account = () => {
		...
		<>
			<div className="border-2 flex flex-col items-center p-6 gap-3">
				...
				<div className="flex gap-3">
					...
					<input className="bg-white px-2 border-none outline-none " type='number' onChange={(e)=>{handleChange(e)}}/>
					<button className="bg-gray-400 px-2" onClick={()=>{dispatch(incrementByAmount(Number(num)))}}>Increment By {num}+</button>
